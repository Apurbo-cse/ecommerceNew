        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="active">New blog create</li>
                </ol>
                        ...
                        <div class="col-xs-12">
                            <form role="form" action="{{route('admin.blog.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" id="ex1" placeholder="Enter blog title">
                                </div>
                                @error('title')
