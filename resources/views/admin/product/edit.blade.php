                        ...
                        <div class="col-xs-12">
                            <form role="form" action="{{route('admin.products.update', $product->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($product->image ? $product->image : 'images/static/no-product-image.png')}}" alt="no-product-image.png" class="img-responsive w-lg" style="height: 200px;">
                                </div>
                                <div class="form-group">
                                    <label for="image">Product image</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($product->image_two  ? $product->image_two : 'images/static/no-product-image.png')}}" alt="no-product-image.png" class="img-responsive w-lg" style="height: 200px;">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($product->image_three ? $product->image_three : 'images/static/no-product-image.png')}}" alt="no-product-image.png" class="img-responsive w-lg" style="height: 200px;">
                                </div>
                                <div class="form-group">
