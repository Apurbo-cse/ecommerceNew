        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.fairTradeInfo.index')}}">Material Info</a></li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <form role="form" action="{{route('admin.fairTradeInfo.update', $fairTradeInfo->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" name="description">
                                        {{$fairTradeInfo->description ? $fairTradeInfo->description : old('description') }}
                                   </textarea>
                                </div>
                                @error('description')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="tinymce" name="tech_description">
                                        {{$fairTradeInfo->tech_description ? $fairTradeInfo->tech_description : old('tech_description') }}
                                   </textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($fairTradeInfo->image)}}" alt="slider thumbnail" class="img-responsive w-lg" style="height: 200px;">
                                </div>
                                <div class="form-group">
